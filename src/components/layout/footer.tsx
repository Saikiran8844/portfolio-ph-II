        ...
        <div className="grid grid-cols-1 gap-12 border-t border-border/40 pt-12 md:grid-cols-12 md:gap-6">
          ...
          >
            <Link href="/" className="flex w-fit items-center gap-3">
              <div className="relative size-10 overflow-hidden rounded-xl bg-linear-to-br from-background to-muted border border-border shadow-sm flex items-center justify-center">
                <Image
                  src="/md-red-logo.svg"
                  alt="Logo"
                  width={24}
            ...
            <p className="max-w-xs text-muted-foreground text-sm leading-relaxed font-light">
              Software Engineer &amp; Creative Technologist. Crafting resilient distributed systems, modern web software, and AI tooling.
            </p>
          </motion.div>
          ...
          >
            ...
            {[
              ...
              >
                <Link
                  href={item.href}
                  className="w-fit text-sm text-foreground/80 hover:text-primary hover:translate-x-1 transition-all duration-300"
                >
                  {item.label}
                </Link>
              </motion.div>
